...
// Complete definitions for all 98 DC Characters
const dcCharacters = [
  // ==========================================
  // TANKS (16)
  // ==========================================
  {
    ...
    role: 'Tank',
    rarity: 'Cosmic',
    stats: { power: 99, strength: 100, speed: 96, durability: 99, combat: 85, range: 92, intelligence: 88 },
    specialAbilities: ['Solar Overcharge', 'Heat Vision Sweep', 'Super Breath Freeze', 'Man of Steel Aegis'],
    ...
    matchupStrengths: ['Pure Brawlers', 'Blasters', 'Tech Weapons'],
    matchupWeaknesses: ['Cosmic Sorcerers', 'Reality Manipulation', 'Kryptonite / Magic'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Cosmic',
    stats: { power: 98, strength: 99, speed: 78, durability: 98, combat: 92, range: 97, intelligence: 95 },
    specialAbilities: ['Omega Beams', 'Anti-Life Equation', 'Apokoliptian Crushing Grip', 'Dimensional Disintegration'],
    ...
    matchupStrengths: ['Speedsters', 'Brutes', 'Tech Armor'],
    matchupWeaknesses: ['Reality Warpers', 'Source Manipulation'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Cosmic',
    stats: { power: 97, strength: 99, speed: 80, durability: 99, combat: 86, range: 60, intelligence: 55 },
    specialAbilities: ['Adaptive Regeneration', 'Bone Spike Impalement', 'Apocalyptic Rage', 'Invulnerable Carapace'],
    ...
    matchupStrengths: ['Melee Bruisers', 'Physical Strikers', 'Kinetic Attackers'],
    matchupWeaknesses: ['Mental Domination', 'Banishment', 'Dimensional Traps'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Epic',
    stats: { power: 84, strength: 89, speed: 68, durability: 88, combat: 91, range: 45, intelligence: 89 },
    specialAbilities: ['Venom Injection', 'Backbreaker Slam', 'Tactical Mastermind', 'Unstoppable Momentum'],
    ...
    matchupStrengths: ['Street-Level Strikers', 'Assassins'],
    matchupWeaknesses: ['Flight Users', 'Energy Blasters', 'Venom Hose Severing'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Epic',
    stats: { power: 86, strength: 94, speed: 52, durability: 95, combat: 65, range: 40, intelligence: 35 },
    specialAbilities: ['Undead Resilience', 'Slaughter Swamp Surge', 'Crushing Bearhug', 'Resurrection Curse'],
    ...
    matchupStrengths: ['Physical Strikers', 'Poison / Toxins'],
    matchupWeaknesses: ['Fire', 'Holy Magic', 'High Range Blasters'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Legendary',
    stats: { power: 93, strength: 96, speed: 76, durability: 98, combat: 89, range: 70, intelligence: 82 },
    specialAbilities: ['Hook & Chain Carnage', 'Immortal Czarnian Healing', 'Spacehog Strafe', 'Frag-Em Frag Grenades'],
    ...
    matchupStrengths: ['Brutes', 'Demons', 'Cosmic Enforcers'],
    matchupWeaknesses: ['Mental Control', 'Dimensional Banishment'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Epic',
    stats: { power: 90, strength: 95, speed: 82, durability: 94, combat: 70, range: 85, intelligence: 45 },
    specialAbilities: ['Flame Breath', 'Freeze Vision', 'Chalk-White Resilience', 'Backwards Logic Bash'],
    ...
    matchupStrengths: ['Ice Users', 'Standard Energy Tanks'],
    matchupWeaknesses: ['Complex Tactics', 'Psychic Trickery'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Legendary',
    stats: { power: 94, strength: 95, speed: 60, durability: 98, combat: 80, range: 88, intelligence: 88 },
    specialAbilities: ['Avatar of the Green', 'Bio-Mass Regeneration', 'Spore Hallucination', 'Elemental Root Tendrils'],
    ...
    matchupStrengths: ['Poison Users', 'Physical Brawlers', 'Earth Magic'],
    matchupWeaknesses: ['Intense Flame', 'Defoliants / Chemical Rot'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Rare',
    stats: { power: 78, strength: 86, speed: 64, durability: 87, combat: 76, range: 35, intelligence: 45 },
    specialAbilities: ['Armored Reptilian Scales', 'Death Roll Thrash', 'Sewer Ambush', 'Apex Predator Bite'],
    ...
    matchupStrengths: ['Street Fighters', 'Unarmored Rogues'],
    matchupWeaknesses: ['High Altitude Attacks', 'Heavy Artillery', 'Cold Temperatures'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Legendary',
    stats: { power: 92, strength: 95, speed: 75, durability: 94, combat: 93, range: 75, intelligence: 86 },
    specialAbilities: ['Electro-Axe Cleave', 'Parademons Swarm Call', 'Apokoliptian Armor', 'Conqueror\'s Trample'],
    ...
    matchupStrengths: ['Standard Soldiers', 'Shielded Targets'],
    matchupWeaknesses: ['Kryptonian Speed', 'Divine Magic'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Cosmic',
    stats: { power: 99, strength: 100, speed: 98, durability: 99, combat: 88, range: 94, intelligence: 85 },
    specialAbilities: ['Reality-Shattering Punch', 'Yellow Sun Armor Boost', 'Heat Vision Barrage', 'Rage Tantrum'],
    ...
    matchupStrengths: ['Almost all heroes', 'Reality Anchors'],
    matchupWeaknesses: ['Red Sun Energy Drain', 'Speed Force Entrapment'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Rare',
    stats: { power: 80, strength: 89, speed: 65, durability: 90, combat: 74, range: 30, intelligence: 40 },
    specialAbilities: ['Shark God Demigod Toughness', 'Chomp Frenzy', 'Oceanic Depth Adaptation', 'Blood Scent Rage'],
    ...
    matchupStrengths: ['Naval Combat', 'Melee Infiltrators'],
    matchupWeaknesses: ['Dehydration', 'Heavy Electricity', 'High Mobility Blasters'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Rare',
    stats: { power: 82, strength: 92, speed: 56, durability: 89, combat: 72, range: 50, intelligence: 78 },
    specialAbilities: ['Colossal Growth', 'Seismic Stomp', 'Giant Haymaker', 'Scientific Insight'],
    ...
    matchupStrengths: ['Small Strikers', 'Light Vehicles'],
    matchupWeaknesses: ['Speedsters', 'Precision Nerve Strikes'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Epic',
    stats: { power: 88, strength: 91, speed: 70, durability: 89, combat: 85, range: 75, intelligence: 94 },
    specialAbilities: ['Telepathic Mind Blast', 'Simian Savage Beatdown', 'Mind Control Override', 'Forcefield Projection'],
    ...
    matchupStrengths: ['Unshielded Minds', 'Pure Brawlers'],
    matchupWeaknesses: ['Speed Force Acceleration', 'Psychic Immunity Helmets'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Epic',
    stats: { power: 89, strength: 93, speed: 72, durability: 92, combat: 87, range: 84, intelligence: 82 },
    specialAbilities: ['Emerald Construct Anvil', 'Drill Sergeant Roar', 'Bolovaxian Brute Force', 'Ring Battery Barrier'],
    ...
    matchupStrengths: ['Recruits', 'Energy Attackers'],
    matchupWeaknesses: ['Yellow Fear Energy', 'Willpower Fatigue'],
  ...
  },
  {
    ...
    role: 'Tank',
    rarity: 'Rare',
    stats: { power: 83, strength: 93, speed: 55, durability: 94, combat: 75, range: 35, intelligence: 68 },
    specialAbilities: ['Organic Steel Skin', 'Unstoppable Charging Bash', 'Heavy Metal Absorption', 'JSA Bulwark'],
    ...
    matchupStrengths: ['Ballistic Fire', 'Piercing Weapons'],
    matchupWeaknesses: ['Extreme Magnetism', 'Acidic Dissolution'],
  ...
  // ==========================================
  {
    ...
    role: 'Striker',
    rarity: 'Legendary',
    stats: { power: 96, strength: 97, speed: 90, durability: 96, combat: 99, range: 82, intelligence: 90 },
    specialAbilities: ['Lasso of Truth Bind', 'Bracelets of Submission Deflect', 'Godkiller Blade Slice', 'Amazonian War Cry'],
    ...
    matchupStrengths: ['Monsters', 'Brawlers', 'Warriors'],
    matchupWeaknesses: ['High-Tier Reality Warpers', 'Piercing Piercers while undefended'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Legendary',
    stats: { power: 91, strength: 78, speed: 82, durability: 80, combat: 99, range: 85, intelligence: 100 },
    specialAbilities: ['Contingency Plan Execution', 'Batarang Flurry', 'Smoke Bomb Disappearance', 'Martial Mastery Counter'],
    ...
    matchupStrengths: ['Arrogant Titans', 'Rogues', 'Predictable Opponents'],
    matchupWeaknesses: ['Unprepared Ambush by Godlike Speedsters'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Legendary',
    stats: { power: 90, strength: 85, speed: 84, durability: 86, combat: 98, range: 88, intelligence: 95 },
    specialAbilities: ['Promethium Broadsword', 'Energy Lance Blast', 'Enhanced 90% Brain Capacity', 'Healing Factor Surge'],
    ...
    matchupStrengths: ['Teen Titans', 'Martial Artists', 'Tacticians'],
    matchupWeaknesses: ['Speedsters at Full Acceleration', 'Cosmic Energy Entities'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Epic',
    stats: { power: 85, strength: 75, speed: 88, durability: 78, combat: 96, range: 75, intelligence: 90 },
    specialAbilities: ['Escrima Stick Electrocution', 'Quadruple Somersault Takedown', 'Wing-Ding Barrage', 'Leader of the Titans'],
    ...
    matchupStrengths: ['Heavy Bruisers', 'Assassins'],
    matchupWeaknesses: ['Superhuman Speedster Speed', 'Giant Area-of-Effect Blasts'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Epic',
    stats: { power: 86, strength: 80, speed: 82, durability: 82, combat: 93, range: 88, intelligence: 86 },
    specialAbilities: ['Dual Pistol Rapid Fire', 'All-Blade Summon', 'Explosive Charge Grenades', 'Lazarus Pit Fury'],
    ...
    matchupStrengths: ['Underworld Bosses', 'Non-Lethal Heroes'],
    matchupWeaknesses: ['Armored Colossi', 'Mental Illusions'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Cosmic',
    stats: { power: 97, strength: 98, speed: 94, durability: 97, combat: 94, range: 90, intelligence: 89 },
    specialAbilities: ['SHAZAM Lightning Wrath', 'Khandaq Ruthless Cleave', 'Amon Stamina Shield', 'Supersonic Bullrush'],
    ...
    matchupStrengths: ['Tech Armor', 'Demons', 'Earth Champions'],
    matchupWeaknesses: ['Divine Egyptian Counter-Spells', 'Overwhelming Mystic Hordes'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Legendary',
    stats: { power: 92, strength: 96, speed: 78, durability: 95, combat: 95, range: 75, intelligence: 80 },
    specialAbilities: ['Mega-Rod Concussion Blast', 'Female Fury Combat Prowess', 'Apokoliptian Armor', 'Boom Tube Breach'],
    ...
    matchupStrengths: ['Brutes', 'Alien Soldiers'],
    matchupWeaknesses: ['Psychic Domination', 'Speedster Blitzes'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Legendary',
    stats: { power: 96, strength: 97, speed: 92, durability: 96, combat: 85, range: 88, intelligence: 84 },
    specialAbilities: ['Lightning Bolt Transformation', 'Wisdom of Solomon', 'Strength of Hercules', 'Speed of Mercury'],
    ...
    matchupStrengths: ['Physical Tanks', 'Science-Based Foes'],
    matchupWeaknesses: ['High Sorcery', 'Forced Reversion to Child Form'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Legendary',
    stats: { power: 92, strength: 93, speed: 84, durability: 92, combat: 91, range: 80, intelligence: 82 },
    specialAbilities: ['Trident of Neptune Impalement', 'Oceanic Tsunami Call', 'Telepathic Leviathan Command', 'Atlantean Durability'],
    ...
    matchupStrengths: ['Fire Users', 'Desert Environments', 'Naval Armadas'],
    matchupWeaknesses: ['Extreme Evaporation', 'Dessication Attacks'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Legendary',
    stats: { power: 95, strength: 96, speed: 80, durability: 95, combat: 99, range: 84, intelligence: 92 },
    specialAbilities: ['War God Blade of Chaos', 'Conflict Empowerment', 'Undead Spartan Army', 'Armor of Olympus'],
    ...
    matchupStrengths: ['Prolonged Melee Clashes', 'Bloodthirsty Enemies'],
    matchupWeaknesses: ['Peace / Pacifist Magic', 'Love / Truth Deities'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Rare',
    stats: { power: 80, strength: 70, speed: 82, durability: 72, combat: 90, range: 74, intelligence: 95 },
    specialAbilities: ['Escrima Strike Sequence', 'Batarang Rapid Volley', 'Photographic Memory Analysis', 'Hacker Override'],
    ...
    matchupStrengths: ['Street Thugs', 'Tech Security Systems'],
    matchupWeaknesses: ['Superhuman Brutes', 'Titan-tier Durability'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Rare',
    stats: { power: 82, strength: 74, speed: 80, durability: 76, combat: 92, range: 78, intelligence: 88 },
    specialAbilities: ['Military CQC Strike', 'Red Batarang Burst', 'Armored Cape Shield', 'Tactical Smoke Retreat'],
    ...
    matchupStrengths: ['Paramilitary Operatives', 'Assassins'],
    matchupWeaknesses: ['Cosmic Beings', 'Heavy Energy Artillery'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Rare',
    stats: { power: 83, strength: 82, speed: 79, durability: 80, combat: 90, range: 65, intelligence: 76 },
    specialAbilities: ['Flambeau Flaming Blades', 'Order of St. Dumas Conditioning', 'Zealot Retribution', 'Thermal Gauntlet Fire'],
    ...
    matchupStrengths: ['Corrupt Cults', 'Melee Fighters'],
    matchupWeaknesses: ['Mental Triggers', 'Tactical Psychological Warfare'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Rare',
    stats: { power: 84, strength: 85, speed: 86, durability: 80, combat: 88, range: 60, intelligence: 78 },
    specialAbilities: ['Tantu Totem Mimicry', 'Cheetah Sprint Attack', 'Elephant Charge Stampede', 'Falcon Dive Strike'],
    ...
    matchupStrengths: ['Single-Style Combatants'],
    matchupWeaknesses: ['Totem Disruption', 'Sonic Overload'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Rare',
    stats: { power: 81, strength: 87, speed: 72, durability: 85, combat: 86, range: 40, intelligence: 60 },
    specialAbilities: ['Avatar of War Berserk', 'Crushing Clothesline', 'Chaos Infused Punch', 'Pain Tolerance Surge'],
    ...
    matchupStrengths: ['Lightweight Fighters', 'Street Gangs'],
    matchupWeaknesses: ['Calm Tacticians', 'Energy Snipers'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Epic',
    stats: { power: 88, strength: 89, speed: 85, durability: 88, combat: 93, range: 76, intelligence: 82 },
    specialAbilities: ['Nth Metal Mace Smash', 'Winged Aerial Dive', 'Anti-Magic Disruption', 'Centuries of Reincarnation'],
    ...
    matchupStrengths: ['Sorcerers', 'Magical Entities', 'Airborne Foes'],
    matchupWeaknesses: ['Colossal Brutes', 'Snipers outside dive range'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Rare',
    stats: { power: 81, strength: 72, speed: 82, durability: 74, combat: 91, range: 78, intelligence: 97 },
    specialAbilities: ['Bo Staff Kinetic Spin', 'Detective Deductive Flaw Find', 'Grapple Glider Strike', 'Flashbang Barrage'],
    ...
    matchupStrengths: ['Puzzle Bosses', 'Ambushers'],
    matchupWeaknesses: ['Kryptonian-Tier Brutes'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Rare',
    stats: { power: 80, strength: 70, speed: 84, durability: 72, combat: 93, range: 75, intelligence: 88 },
    specialAbilities: ['Katana Assassin Sever', 'League of Assassins Agility', 'Birdarang Volley', 'Arrogant Pressure Point Strike'],
    ...
    matchupStrengths: ['Standard Martial Artists', 'Mercenaries'],
    matchupWeaknesses: ['Heavy Armor Tanks', 'Overconfidence'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Rare',
    stats: { power: 79, strength: 70, speed: 80, durability: 74, combat: 89, range: 85, intelligence: 80 },
    specialAbilities: ['Crossbow Precision Bolt', 'Mafia Vendetta Strike', 'Acrobatic Vault Flurry', 'Smoke Pellets'],
    ...
    matchupStrengths: ['Mob Enforcers', 'Assassins'],
    matchupWeaknesses: ['Heavy Armor Colossi', 'Speedsters'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Rare',
    stats: { power: 78, strength: 65, speed: 88, durability: 70, combat: 89, range: 70, intelligence: 84 },
    specialAbilities: ['Bullwhip Disarm', 'Nine Lives Evasion', 'Diamond Claw Slash', 'Caltrop Trap Drop'],
    ...
    matchupStrengths: ['Slow Bruisers', 'Armed Human Guards'],
    matchupWeaknesses: ['Heavy Area Artillery', 'Telepaths'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Epic',
    stats: { power: 88, strength: 76, speed: 85, durability: 80, combat: 97, range: 88, intelligence: 85 },
    specialAbilities: ['Canary Cry Sonic Wave', 'Judo Sweep & Disarm', 'Sonic Propulsion Jump', 'Birds of Prey Command'],
    ...
    matchupStrengths: ['Group Formations', 'Energy Shield Users'],
    matchupWeaknesses: ['Sonic Dampening Tech', 'Vocal Cord Suppressors'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Epic',
    stats: { power: 89, strength: 88, speed: 95, durability: 85, combat: 91, range: 45, intelligence: 82 },
    specialAbilities: ['Goddess of the Hunt Fangs', 'Hyperspeed Pounce', 'Claw Tear Laceration', 'Bloodlust Frenzy'],
    ...
    matchupStrengths: ['Gods', 'Amazon Warriors'],
    matchupWeaknesses: ['Aura Disruption', 'Heavy Electro-Traps'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Epic',
    stats: { power: 85, strength: 74, speed: 82, durability: 76, combat: 93, range: 96, intelligence: 88 },
    specialAbilities: ['Boxing Glove Arrow Knockout', 'Explosive Trick Arrow Volley', 'Thermite Penetrator', 'Robin Hood Marksmanship'],
    ...
    matchupStrengths: ['Assassins', 'Corrupt Executives'],
    matchupWeaknesses: ['Kryptonian-Scale Invulnerability', 'Speedsters catching arrows'],
  ...
  },
  {
    ...
    role: 'Striker',
    rarity: 'Common',
    stats: { power: 72, strength: 62, speed: 78, durability: 68, combat: 84, range: 88, intelligence: 72 },
    specialAbilities: ['Rapid Arrow Triple Shot', 'Taser Arrow Stun', 'Acrobatic Flip Shot', 'Street Savvy Evasion'],
    ...
    matchupStrengths: ['Street Thugs'],
    matchupWeaknesses: ['Heavy Armor Tanks'],
  ...
  // ==========================================
  {
    ...
    role: 'Blaster',
    rarity: 'Epic',
    stats: { power: 91, strength: 90, speed: 78, durability: 92, combat: 82, range: 94, intelligence: 96 },
    specialAbilities: ['White Noise Cannon', 'Boom Tube Portal', 'Cybernetic Tech Override', 'Promethium Rocket Salvo'],
    ...
    matchupStrengths: ['Tech Armor', 'Robotics', 'Digital Defenses'],
    matchupWeaknesses: ['Electromagnetic EMP Disruption', 'Ancient Magic'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Legendary',
    stats: { power: 95, strength: 92, speed: 90, durability: 93, combat: 86, range: 97, intelligence: 85 },
    specialAbilities: ['Jet Fighter Construct Barrage', 'Willpower Forcefield Bubble', 'Giant Emerald Fist', 'In Brightest Day Light Burst'],
    ...
    matchupStrengths: ['Fear Entities', 'Space Fleets'],
    matchupWeaknesses: ['Yellow Impurity / Fear Resonance', 'Ring Battery Depletion'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Epic',
    stats: { power: 90, strength: 89, speed: 82, durability: 90, combat: 88, range: 92, intelligence: 76 },
    specialAbilities: ['Red/Green Ring Overcharge', 'Construct Steamroller', 'Barroom Brawl Haymaker', 'Rage-Fueled Blast'],
    ...
    matchupStrengths: ['Conventional Armies', 'Infiltrators'],
    matchupWeaknesses: ['Psychological Provocation', 'Calculated Trap Setters'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Legendary',
    stats: { power: 94, strength: 88, speed: 88, durability: 91, combat: 82, range: 96, intelligence: 90 },
    specialAbilities: ['Artistic Anime Construct', 'White Lantern Emotional Spectrum', 'Emerald Mecha Armor', 'Torchbearer Burst'],
    ...
    matchupStrengths: ['Single-Dimensional Opponents', 'Cosmic Predators'],
    matchupWeaknesses: ['Willpower Emotional Turmoil'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Epic',
    stats: { power: 91, strength: 91, speed: 88, durability: 89, combat: 84, range: 93, intelligence: 78 },
    specialAbilities: ['Starbolt Plasma Stream', 'Ultraviolet Nova Flare', 'Tamaranean Supersonic Flight', 'Warrior Royal Rage'],
    ...
    matchupStrengths: ['Ice Users', 'Armored Infantry', 'Flying Units'],
    matchupWeaknesses: ['Solar Energy Dampeners', 'Cryo Super-Freezers'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Legendary',
    stats: { power: 94, strength: 86, speed: 88, durability: 90, combat: 89, range: 96, intelligence: 95 },
    specialAbilities: ['Yellow Fear Battery Beam', 'Parallax Nightmare Beast', 'Fear Spikes Construct', 'Order Through Tyranny Barrier'],
    ...
    matchupStrengths: ['Hesitant Opponents', 'Willpower-Weak Heroes'],
    matchupWeaknesses: ['Fearless Beings', 'Hope Blue Lantern Energy'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Legendary',
    stats: { power: 95, strength: 88, speed: 85, durability: 92, combat: 78, range: 97, intelligence: 96 },
    specialAbilities: ['Atomic Transmutation', 'Nuclear Concussion Blast', 'Matter Density Phase', 'Fusion Core Eruption'],
    ...
    matchupStrengths: ['Physical Weapons', 'Machinery', 'Ballistic Missiles'],
    matchupWeaknesses: ['Organic Matter Blindspot', 'Matrix Internal Discord'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Epic',
    stats: { power: 86, strength: 82, speed: 78, durability: 87, combat: 89, range: 92, intelligence: 88 },
    specialAbilities: ['Optic Thermal Death Ray', 'Armor-Piercing Torpedoes', 'Electrified Harpoon Cable', 'Atlantean Steel Armor'],
    ...
    matchupStrengths: ['Aquatic Opponents', 'Flesh-and-Blood Heroes'],
    matchupWeaknesses: ['Godlike Durability', 'EMP Blasts'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Rare',
    stats: { power: 83, strength: 68, speed: 72, durability: 78, combat: 80, range: 90, intelligence: 89 },
    specialAbilities: ['Absolute Zero Cold Gun', 'Cold Field Momentum Brake', 'Ice Wall Rampart', 'Rogues Leader Discipline'],
    ...
    matchupStrengths: ['Speedsters', 'Flame Attackers'],
    matchupWeaknesses: ['Laser Heavy Blasters', 'Extreme Long-Range Snipers'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Epic',
    stats: { power: 84, strength: 72, speed: 80, durability: 80, combat: 88, range: 98, intelligence: 85 },
    specialAbilities: ['Wrist-Mounted Machine Gun Spray', 'Trick Ricochet Sniper Shot', 'Thermal Targeting HUD', 'Suicide Squad Precision'],
    ...
    matchupStrengths: ['Unarmored Targets', 'Cover Campers'],
    matchupWeaknesses: ['Invulnerable Metallic Tanks', 'Hyperspeed Blitzers'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Epic',
    stats: { power: 91, strength: 88, speed: 88, durability: 91, combat: 80, range: 94, intelligence: 85 },
    specialAbilities: ['Khaji Da Sonic Cannon', 'Plasma Blade Morph', 'Winged Flight Shield', 'Infiltrator AI Countermeasure'],
    ...
    matchupStrengths: ['Alien War Fleets', 'Energy Users'],
    matchupWeaknesses: ['Mystical Sorcery', 'Scarab Overwrite'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Rare',
    stats: { power: 80, strength: 72, speed: 68, durability: 80, combat: 76, range: 88, intelligence: 70 },
    specialAbilities: ['Pyrotechnic Flamethrower Stream', 'Napalm Ground Trap', 'Asbestos Heat Armor', 'Firebug Incineration'],
    ...
    matchupStrengths: ['Cryo Attackers', 'Plant Elementals'],
    matchupWeaknesses: ['Water Deluges', 'Heavy Armor Tanks'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Epic',
    stats: { power: 89, strength: 86, speed: 88, durability: 88, combat: 78, range: 94, intelligence: 88 },
    specialAbilities: ['F5 Tornado Vortex', 'Air Pressure Cyclone', 'Android Body Reconstruction', 'Atmospheric Vacuum'],
    ...
    matchupStrengths: ['Ground Swarms', 'Poison Gas / Clouds'],
    matchupWeaknesses: ['Heavy EMP Disruption', 'Sub-Zero Freezing'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Legendary',
    stats: { power: 95, strength: 94, speed: 90, durability: 95, combat: 82, range: 97, intelligence: 86 },
    specialAbilities: ['Quantum Field Blast', 'Dilustel Metal Armor Invulnerability', 'Energy Siphon Absorption', 'Nuclear Detonation'],
    ...
    matchupStrengths: ['Energy Blasters', 'Radiation Attackers'],
    matchupWeaknesses: ['Dilustel Armor Breaches causing quantum containment leaks'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Epic',
    stats: { power: 87, strength: 78, speed: 82, durability: 82, combat: 86, range: 92, intelligence: 88 },
    specialAbilities: ['Bio-Electric Lightning Arc', 'Forcefield Ion Barrier', 'Supercharged Jump Kick', 'Electromagnetic Levitation'],
    ...
    matchupStrengths: ['Robotics', 'Cyborgs', 'Gang Enforcers'],
    matchupWeaknesses: ['Rubber / Grounded Insulators', 'Heavy Rock Tanks'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Epic',
    stats: { power: 88, strength: 75, speed: 85, durability: 80, combat: 82, range: 93, intelligence: 92 },
    specialAbilities: ['Electromagnetic Manhole Disc Flight', 'Static Cling Taser', 'EMP Pulse Burst', 'Magnetic Metal Attraction'],
    ...
    matchupStrengths: ['Gunmen', 'Metal Armored Tanks', 'Electronic Tech'],
    matchupWeaknesses: ['Insulated Non-Conductive Materials', 'Submersion in Water'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Epic',
    stats: { power: 88, strength: 90, speed: 76, durability: 91, combat: 83, range: 90, intelligence: 95 },
    specialAbilities: ['Kinetic Hammer Throw', 'Pneumatic Rocket Boost', 'Chest Laser Rivet', 'Magnetic Field Deflector'],
    ...
    matchupStrengths: ['Street Crime', 'Brutes'],
    matchupWeaknesses: ['EMP Disruption', 'High-Tier Sorcery'],
  ...
  },
  {
    ...
    role: 'Blaster',
    rarity: 'Rare',
    stats: { power: 84, strength: 78, speed: 82, durability: 82, combat: 80, range: 91, intelligence: 76 },
    specialAbilities: ['Cosmic Staff Stellar Beam', 'Stellar Energy Forcefield', 'High-Speed Aerial Loops', 'Cosmic Converter Belt Punch'],
    ...
    matchupStrengths: ['Shadow / Darkness Beings', 'Infiltrators'],
    matchupWeaknesses: ['Disarming Cosmic Staff', 'Brutal CQC Grapplers'],
  ...
  // ==========================================
  {
    ...
    role: 'Tactician',
    rarity: 'Legendary',
    stats: { power: 93, strength: 88, speed: 78, durability: 92, combat: 84, range: 93, intelligence: 100 },
    specialAbilities: ['Warsuit Kryptonite Blaster', 'Corporate Masterstroke', 'Forcefield Grid Overload', 'LuthorCorp War Drone'],
    ...
    matchupStrengths: ['Kryptonians', 'Predictable Superheroes', 'Brutes'],
    matchupWeaknesses: ['Uncontrolled Berserkers', 'Reality Manipulation'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Cosmic',
    stats: { power: 96, strength: 89, speed: 82, durability: 94, combat: 85, range: 95, intelligence: 100 },
    specialAbilities: ['12th-Level Intellect', 'City Bottle Ray', 'Skull Ship Cybernetic Blast', 'Nanite Hive Assimilation'],
    ...
    matchupStrengths: ['Planetary Civilizations', 'Conventional Technology'],
    matchupWeaknesses: ['Chaos Magic', 'Illogical Wildcards'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Rare',
    stats: { power: 76, strength: 60, speed: 65, durability: 68, combat: 70, range: 68, intelligence: 98 },
    specialAbilities: ['Question Mark Cane Shock', 'Death Trap Mechanism', 'Riddle Me This Puzzle Debuff', 'Laser Grid Maze'],
    ...
    matchupStrengths: ['Slow Thinkers', 'Predictable Detectives'],
    matchupWeaknesses: ['Direct Berserkers', 'Instant Destruction'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Legendary',
    stats: { power: 90, strength: 80, speed: 82, durability: 86, combat: 96, range: 75, intelligence: 98 },
    specialAbilities: ['Lazarus Pit Immortality', 'Scimitar Duelist Master', 'League of Assassins Swarm', 'Eco-Terrorist Bioweapon'],
    ...
    matchupStrengths: ['Corrupt Governments', 'Conventional Armies'],
    matchupWeaknesses: ['Lazarus Madness', 'Batman\'s Code'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Rare',
    stats: { power: 78, strength: 70, speed: 75, durability: 74, combat: 88, range: 60, intelligence: 94 },
    specialAbilities: ['Pseudoderm Faceless Mask', 'Conspiracy Deduction', 'Kung Fu Pressure Strike', 'Smoke Gas Escape'],
    ...
    matchupStrengths: ['Corrupt Conspiracies', 'Infiltrators'],
    matchupWeaknesses: ['Overwhelming Superhuman Force'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Common',
    stats: { power: 73, strength: 62, speed: 58, durability: 70, combat: 72, range: 75, intelligence: 90 },
    specialAbilities: ['Umbrella Machine Gun', 'Helicopter Umbrella Escape', 'Iceberg Lounge Underworld Network', 'Poison Gas Umbrella Tip'],
    ...
    matchupStrengths: ['Street Thugs', 'Bribeable Rogues'],
    matchupWeaknesses: ['Superhuman Heavyweights'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Rare',
    stats: { power: 76, strength: 68, speed: 68, durability: 72, combat: 78, range: 78, intelligence: 88 },
    specialAbilities: ['Double-Headed Coin Toss', 'Dual Tommy Gun Fire', 'Duality Ambush', 'Acid Burn Traumatic Surge'],
    ...
    matchupStrengths: ['Predictable Legal Systems', 'Law Enforcement'],
    matchupWeaknesses: ['Coin Interception', 'Superhumans'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Legendary',
    stats: { power: 97, strength: 98, speed: 94, durability: 97, combat: 96, range: 92, intelligence: 95 },
    specialAbilities: ['Kryptonian Military Command', 'Heat Vision Barrage', 'Phantom Zone Rift', 'Kneel Before Zod Aura'],
    ...
    matchupStrengths: ['Militaries', 'Inexperienced Superheroes', 'Brutes'],
    matchupWeaknesses: ['Red Sun Radiation', 'Phantom Zone Banishment'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Legendary',
    stats: { power: 88, strength: 70, speed: 78, durability: 85, combat: 86, range: 82, intelligence: 98 },
    specialAbilities: ['Joker Venom Asphyxiation', 'Acid Lapel Flower Spritz', 'Joy Buzzer Lethal Shock', 'Agent of Pure Chaos'],
    ...
    matchupStrengths: ['Orderly Strategists', 'Moral Heroes'],
    matchupWeaknesses: ['Ruthless Non-Hesitant Lethal Assassins'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Epic',
    stats: { power: 84, strength: 75, speed: 86, durability: 78, combat: 88, range: 80, intelligence: 91 },
    specialAbilities: ['Oversized Mallet Whack', 'Pop-Gun Cork Blast', 'Acrobatic Gymnastics Evasion', 'Toxin Immunity Boost'],
    ...
    matchupStrengths: ['Predictable Lawmen', 'Serious Fighters'],
    matchupWeaknesses: ['Godlike Speedsters', 'Cosmic Beings'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Rare',
    stats: { power: 80, strength: 65, speed: 70, durability: 72, combat: 76, range: 85, intelligence: 95 },
    specialAbilities: ['Fear Toxin Hallucination', 'Scythe Reaping Slash', 'Phobia Induction Neuro-Gas', 'Nightmare Panic Aura'],
    ...
    matchupStrengths: ['Heroes with Hidden Traumas', 'Organic Beings'],
    matchupWeaknesses: ['Gas Masked Opponents', 'Robots / Synths', 'Fearless Beings'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Epic',
    stats: { power: 86, strength: 84, speed: 65, durability: 90, combat: 78, range: 91, intelligence: 96 },
    specialAbilities: ['Cryo-Suit Sub-Zero Armor', 'Freeze Ray Glacier Blast', 'Permafrost Area Snare', 'Nora\'s Ice Heart Drive'],
    ...
    matchupStrengths: ['Organic Brawlers', 'Speedsters on slippery surfaces'],
    matchupWeaknesses: ['Extreme Thermal Heat', 'Cryo-Suit Helmet Breach'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Epic',
    stats: { power: 89, strength: 75, speed: 74, durability: 80, combat: 78, range: 92, intelligence: 95 },
    specialAbilities: ['Pheromone Mind Seduction', 'Carnivorous Plant Vine Entangle', 'Toxic Spore Cloud', 'Chlorokinesis Wave'],
    ...
    matchupStrengths: ['Male Superhumans', 'Organic Fighters'],
    matchupWeaknesses: ['Fire / Defoliants', 'Robots / Non-Biological Constructs'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Legendary',
    stats: { power: 92, strength: 82, speed: 90, durability: 82, combat: 98, range: 82, intelligence: 100 },
    specialAbilities: ['35 Minutes Ago Execution', 'Bullet Catch Reflexes', 'Global Geopolitical Trap', 'Genius Martial Perfection'],
    ...
    matchupStrengths: ['Conventional Superheroes', 'Political Leaders'],
    matchupWeaknesses: ['Cosmic Omnipresent Deities like Dr. Manhattan'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Epic',
    stats: { power: 82, strength: 74, speed: 76, durability: 82, combat: 92, range: 65, intelligence: 88 },
    specialAbilities: ['Improvised Weapon Lethality', 'Shifting Inkblot Mask Intimidation', 'Grappling Gun Stun', 'Never Compromise Unbreakable Will'],
    ...
    matchupStrengths: ['Criminal Underworld', 'Deceptive Rogues'],
    matchupWeaknesses: ['Superhuman Planetary Forces'],
  ...
  },
  {
    ...
    role: 'Tactician',
    rarity: 'Rare',
    stats: { power: 80, strength: 78, speed: 72, durability: 78, combat: 89, range: 88, intelligence: 84 },
    specialAbilities: ['Flamethrower & Riot Shotgun', 'Cynical Dirty Fighting', 'Smiley Face Badge Morale Strike', 'Military Spec-Ops Ambush'],
    ...
    matchupStrengths: ['Idealistic Heroes', 'Guerrilla Armies'],
    matchupWeaknesses: ['Superhuman Tanks', 'Bulletproof Meta-beings'],
  ...
  // ==========================================
  {
    ...
    role: 'Speedster',
    rarity: 'Legendary',
    stats: { power: 96, strength: 80, speed: 100, durability: 85, combat: 88, range: 85, intelligence: 94 },
    specialAbilities: ['Infinite Mass Punch', 'Speed Force Phasing', 'Time Remnant Blitz', 'Supersonic Tornado Spin'],
    ...
    matchupStrengths: ['Slow Tanks', 'Projectiles', 'Physical Bruisers'],
    matchupWeaknesses: ['Absolute Zero Cold Fields', 'Temporal Paradoxes'],
  ...
  },
  {
    ...
    role: 'Speedster',
    rarity: 'Legendary',
    stats: { power: 96, strength: 82, speed: 100, durability: 86, combat: 90, range: 86, intelligence: 98 },
    specialAbilities: ['Negative Speed Force Lightning', 'Time Paradox Immortality', 'Vibrational Heart Stop', 'Timeline Erasure'],
    ...
    matchupStrengths: ['Heroes with Fixed Timelines', 'Standard Speedsters'],
    matchupWeaknesses: ['Speed Force Singularity Dissolution'],
  ...
  },
  {
    ...
    role: 'Speedster',
    rarity: 'Legendary',
    stats: { power: 97, strength: 82, speed: 100, durability: 86, combat: 90, range: 88, intelligence: 90 },
    specialAbilities: ['Speed Steal', 'Speed Force Construct Armor', 'Multiversal Sprint', 'Chain Lightning Flurry'],
    ...
    matchupStrengths: ['Speedsters', 'High Mobility Infiltrators'],
    matchupWeaknesses: ['Emotional Anchors Disruption'],
  ...
  },
  {
    ...
    role: 'Speedster',
    rarity: 'Epic',
    stats: { power: 88, strength: 74, speed: 96, durability: 80, combat: 82, range: 80, intelligence: 85 },
    specialAbilities: ['Silver Lightning Burst', 'Sonic Boom Kick', 'Youthful Speed Force Dash', 'Whirlwind Deflection'],
    ...
    matchupStrengths: ['Slow Snipers', 'Heavy Bruisers'],
    matchupWeaknesses: ['Inexperience against Master Sorcerers'],
  ...
  },
  {
    ...
    role: 'Speedster',
    rarity: 'Rare',
    stats: { power: 86, strength: 70, speed: 98, durability: 78, combat: 78, range: 80, intelligence: 82 },
    specialAbilities: ['Vibrational Speed Scout Clone', 'Hyperactive Punch Flurry', 'Speed Force Tornado Catch', 'ADHD Reflex Surge'],
    ...
    matchupStrengths: ['Trapped Arenas', 'Predictable Strategy'],
    matchupWeaknesses: ['Calm Psychological Trickery'],
  ...
  },
  {
    ...
    role: 'Speedster',
    rarity: 'Legendary',
    stats: { power: 96, strength: 86, speed: 100, durability: 90, combat: 91, range: 82, intelligence: 92 },
    specialAbilities: ['Relative Time Manipulation', 'Sonic Boom Finger Snap', 'Tragedy Induction Beating', 'Timeline Acceleration'],
    ...
    matchupStrengths: ['Speedsters', 'Kinetic Absorbers'],
    matchupWeaknesses: ['Total Temporal Freezes', 'Reality Warping'],
  ...
  },
  {
    ...
    role: 'Speedster',
    rarity: 'Cosmic',
    stats: { power: 98, strength: 90, speed: 100, durability: 98, combat: 92, range: 85, intelligence: 80 },
    specialAbilities: ['Touch of Death', 'Speed Force Reaping', 'Dimensional Phase Shift', 'Inevitable Pursuit'],
    ...
    matchupStrengths: ['Mortal Speedsters', 'Biological Targets'],
    matchupWeaknesses: ['Running past the End of Time / Heat Death of the Universe'],
  ...
  },
  {
    ...
    role: 'Speedster',
    rarity: 'Epic',
    stats: { power: 90, strength: 78, speed: 95, durability: 84, combat: 89, range: 82, intelligence: 92 },
    specialAbilities: ['Mercury Helmet Ricochet', 'Hard Water Vapors Speed', 'Decades of JSA Experience', 'Slipstream Vacuum'],
    ...
    matchupStrengths: ['Reckless Young Fighters', 'Axis Threats'],
    matchupWeaknesses: ['Exotic Alien Energy Weapons'],
  ...
  },
  {
    ...
    role: 'Speedster',
    rarity: 'Epic',
    stats: { power: 91, strength: 92, speed: 92, durability: 90, combat: 85, range: 86, intelligence: 82 },
    specialAbilities: ['Tactile Telekinesis Shield', 'TTK Disassembly Field', 'Supersonic Flyby Slam', 'Half-Kryptonian Heat Vision'],
    ...
    matchupStrengths: ['Machinery', 'Melee Tanks'],
    matchupWeaknesses: ['Telepathic Assault', 'Kryptonite / Magic'],
  ...
  },
  {
    ...
    role: 'Speedster',
    rarity: 'Legendary',
    stats: { power: 96, strength: 98, speed: 96, durability: 96, combat: 88, range: 90, intelligence: 86 },
    specialAbilities: ['Hyperspeed Bullrush', 'Supergirl Sunburst Flare', 'Freeze Breath Gale', 'Kryptonian Flight Blitz'],
    ...
    matchupStrengths: ['Bruisers', 'Invasion Armadas', 'Tech Titans'],
    matchupWeaknesses: ['Magic / Mystical Curses', 'Red Solar Radiation'],
  ...
  // ==========================================
  {
    ...
    role: 'Sorcerer',
    rarity: 'Cosmic',
    stats: { power: 98, strength: 80, speed: 84, durability: 95, combat: 85, range: 98, intelligence: 99 },
    specialAbilities: ['Helmet of Nabu Egyptian Spell', 'Ankh Symbol Dimensional Ward', 'Order Magic Disintegration', 'Tower of Fate Banishment'],
    ...
    matchupStrengths: ['Chaos Sorcerers', 'Demons', 'Undead'],
    matchupWeaknesses: ['Separation from the Helmet of Nabu'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Legendary',
    stats: { power: 95, strength: 65, speed: 80, durability: 80, combat: 82, range: 97, intelligence: 96 },
    specialAbilities: ['Backward Speech Reality Warp', 'Stage Magic Transmutation', 'Mystic Healing Light', 'Extinguish the Void'],
    ...
    matchupStrengths: ['Physical Brawlers', 'Tech Giants', 'Curse Users'],
    matchupWeaknesses: ['Gagging / Vocal Prevention', 'Rapid Silence Charms'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Epic',
    stats: { power: 92, strength: 68, speed: 75, durability: 84, combat: 80, range: 92, intelligence: 99 },
    specialAbilities: ['Demon Blood Synchronicities', 'Hellfire Banishment Seal', 'Exorcism Sigil Rite', 'Trenchcoat Con-Artist Gambits'],
    ...
    matchupStrengths: ['Demons', 'Arrogant Sorcerers', 'Deals with the Devil'],
    matchupWeaknesses: ['Unthinking Brutes who don\'t listen to talk'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Legendary',
    stats: { power: 96, strength: 72, speed: 82, durability: 88, combat: 84, range: 96, intelligence: 92 },
    specialAbilities: ['Soul-Self Giant Shadow Raven', 'Empathic Pain Absorption', 'Dark Energy Banishment', 'Azarath Metrion Zinthos'],
    ...
    matchupStrengths: ['Psionic Foes', 'Demonic Minions', 'Emotional Attackers'],
    matchupWeaknesses: ['Surrendering to Inner Trigon Demonic Rage'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Epic',
    stats: { power: 93, strength: 95, speed: 78, durability: 95, combat: 89, range: 88, intelligence: 86 },
    specialAbilities: ['Hellfire Exhalation', 'Rhyming Incantation Curse', 'Demon Claws of Belial', 'Immortal Arthurian Armor'],
    ...
    matchupStrengths: ['Holy Warriors who lack holy relics', 'Mortal Men'],
    matchupWeaknesses: ['Holy Water', 'Merlin\'s Binding Spells'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Cosmic',
    stats: { power: 99, strength: 99, speed: 92, durability: 99, combat: 88, range: 100, intelligence: 98 },
    specialAbilities: ['Divine Judgment Smite', 'Cosmic Transmutation of Evildoers', 'Reality Reshaping Wrath', 'Omnipresent Spirit Phase'],
    ...
    matchupStrengths: ['Villains', 'Killers', 'Unholy Fiends'],
    matchupWeaknesses: ['Divine Limits mandated by the Source / The Presence'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Epic',
    stats: { power: 92, strength: 70, speed: 78, durability: 82, combat: 78, range: 95, intelligence: 89 },
    specialAbilities: ['Chaos Hex Bolt', 'Polymorphic Curse Transmutation', 'Shadow Teleportation', 'Mystic Inversion Barrier'],
    ...
    matchupStrengths: ['Non-Magical Brawlers', 'Soldiers'],
    matchupWeaknesses: ['Separation from June Moone host'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Rare',
    stats: { power: 85, strength: 65, speed: 85, durability: 95, combat: 85, range: 75, intelligence: 82 },
    specialAbilities: ['Ghostly Body Possession', 'Intangible Spirit Phase', 'Acrobatic Trapeze Instinct', 'Rama Kushna Karma Shield'],
    ...
    matchupStrengths: ['Physical Strikers without mystical wards'],
    matchupWeaknesses: ['Anti-Astral Containment Wards', 'Demon Exorcisms'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Cosmic',
    stats: { power: 100, strength: 99, speed: 96, durability: 100, combat: 85, range: 100, intelligence: 100 },
    specialAbilities: ['Sub-Atomic Disassembly', 'Simultaneous Omnipresence', 'Timeline Rewriting', 'Cosmic Quantum Intrinsic Field'],
    ...
    matchupStrengths: ['Virtually all existence'],
    matchupWeaknesses: ['Tachyons obscuring precognition', 'Apathetic Detachment'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Legendary',
    stats: { power: 96, strength: 97, speed: 92, durability: 95, combat: 90, range: 95, intelligence: 98 },
    specialAbilities: ['Planetary Telepathy Mind Wipe', 'Molecular Intangibility Phase', 'Martian Vision Heat Beams', 'Shape-Shifting Bio-Morph'],
    ...
    matchupStrengths: ['Tech Armies', 'Brawlers', 'Psychics'],
    matchupWeaknesses: ['Fire / Pyrophobia'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Rare',
    stats: { power: 83, strength: 85, speed: 86, durability: 82, combat: 84, range: 70, intelligence: 76 },
    specialAbilities: ['T-Rex Apex Smash', 'Pterodactyl Supersonic Dive', 'Green Swarm Metamorphosis', 'Gorilla Slam Rampage'],
    ...
    matchupStrengths: ['Inflexible Fighters', 'Traps'],
    matchupWeaknesses: ['Cellular Toxin Dampeners'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Epic',
    stats: { power: 90, strength: 88, speed: 85, durability: 98, combat: 86, range: 90, intelligence: 82 },
    specialAbilities: ['Infinite Elasticity Morph', 'Ballistic Rubber Bouncing', 'Immune to Blunt Trauma', 'Slapstick Anvil Crushing'],
    ...
    matchupStrengths: ['Heavy Physical Bruisers', 'Telepaths'],
    matchupWeaknesses: ['Liquid Nitrogen Freezing', 'Extreme Chemical Acetone'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Epic',
    stats: { power: 92, strength: 89, speed: 85, durability: 90, combat: 90, range: 94, intelligence: 88 },
    specialAbilities: ['Hard-Water Construct Spears', 'Internal Dehydration Blood Drain', 'Tsunami Hydrokinesis', 'Xebelian Battle Trance'],
    ...
    matchupStrengths: ['Aquatic Combatants', 'Fire Users'],
    matchupWeaknesses: ['Arid Desert Evaporation', 'Electricity'],
  ...
  },
  {
    ...
    role: 'Sorcerer',
    rarity: 'Legendary',
    stats: { power: 96, strength: 98, speed: 94, durability: 96, combat: 89, range: 88, intelligence: 90 },
    specialAbilities: ['Earth-Two Kryptonian Punch', 'Heat Vision Sweep', 'Microscopic Sensor Scan', 'Indomitable Will Slam'],
    ...
    matchupStrengths: ['Bruisers', 'Demons', 'Armored Foes'],
    matchupWeaknesses: ['Earth-Two Kryptonite', 'High-Tier Magic'],
...
console.log('DC Characters count:', dcCharacters.length);
const ids = dcCharacters.map(c => c.id);
...
fs.writeFileSync('server/scripts/dc_characters.json', JSON.stringify(dcCharacters, null, 2));
console.log('Saved server/scripts/dc_characters.json');
